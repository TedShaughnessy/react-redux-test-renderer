...
const secondWrapper = connectedTestComponentWithWrappers.addWrapper(
    TestWrapper,
    { name: 'two' }
);
const thirdWrapper = connectedTestComponentWithWrappers.addWrapper(
    TestWrapper,
    { name: 'three' }
);
...
describe('adding wrappers works: ', () => {
    ...
    it('wrapped connected test component', () => {
        ...
        expect(getNullSafeTextContent(result, selector)).toEqual(
            statePropFromStore
        );
    });
    ...
    it('wrapped and with temporary wrapper props and connected test component', () => {
        ...
        expect(getNullSafeTextContent(result, modifiedSelector)).toEqual(
            statePropFromStore
        );
    });
    ...
    it('modified wrapper props do not persist when changing different wrapper props', () => {
      ...
      'body > div > .three > .second-modified > .one > h3';
